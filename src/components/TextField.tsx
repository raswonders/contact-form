...
export function TextField({
  ...
  return (
    <div className={`space-y-2 font-karla ${className}`}>
      ...
      <input
        className={`w-full border ${isValid ? "border-gray-500" : "border-red"} hover:border-green-600 active:border-green-600 focus:outline-green-600 py-3 px-6 rounded-lg`}
